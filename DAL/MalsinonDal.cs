...
namespace Malshinon.DAL
{
      public class MalshinonDal
      {
            ...
            public List<Person> FetchPeople(string query = "SELECT * FROM people")
            {
                  ...
                  catch (Exception ex) { Console.WriteLine($"Error while fetching people: {ex.Message}"); }
                  finally
                  {
            ...
            public bool AddPerson(Person person)
            {
                  ...
                  catch (Exception ex) { Console.WriteLine($"Error while adding person {person.Id}: {ex.Message}"); }
                  finally
                  {
                        if (reader != null && !reader.IsClosed)
                              reader.Close();
